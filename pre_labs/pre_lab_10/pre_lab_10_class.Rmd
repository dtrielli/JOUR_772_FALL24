...
## Chapter **27 Geographic data basics**
...
### Task 2: Load the Maryland zip code map data.
...
### Task 4: Install and load tigris
...
### Task 5: Store counties data and inspect it

**Task** Run the following code. Describe the output in the new dataset. **Answer**
...
### Task 9: Run code to load the foreclosure notice data.
...
### Task 10: Run code to join the zip code shapes with the foreclosure notice data
