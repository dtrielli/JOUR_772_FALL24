...
baltimore_911_with_demographics <- baltimore_911 |> left_join(maryland_zcta, by(zip_code == zcta5n))
```
...
The zip code with the highest rate of calls per 1,000 population, 21217. Some of the neighborhoods in that zip code are Upton, Sandtown-Winchester and Mondawin.
