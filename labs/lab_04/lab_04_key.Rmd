...
#### and then standardize it, focusing on the payees that appear most often.
#### payee_name > Text facet > Set choice count limit > 3000 ok > cluster > select all > Merge Selected and re-cluster

#### change method > nearest neighbor > select all > Merge Selected and re-cluster
...
media_expenses_cleaned <- read_csv("data/media_md_expenses_clean.csv")
